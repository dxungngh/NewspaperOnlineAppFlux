...
public class NewsApiAdapter extends BaseApiAdapter {
    ...
    public void fetchCategoriesOfServer(final OnGetNewsListListener listener) {
    ...
    public void fetchNewsOfCategory(int start, int count, String type, int typeId, int imageMinSize, final OnGetNewsListListener listener) {
    ...
    public void fetchNewsDetail(long newsId, final OnGetNewsDetailListener listener) {
